# October Solution Accelerator - CPQ React-based Card

This project uses the "shuttle bus quotes sample" as a temlate.
The custom card is meant to give a Sales Rep the possibility to configure a HubSpot quote selecting the relative products and addons.
Due to the time constraints during the Solution Accelerator, this card only presents a mocked up process and doen't create an actual quote.
